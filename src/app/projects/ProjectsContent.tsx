        ...
        >
          <div className="glass-card rounded-2xl p-12 border border-slate-700/50 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <a
                href="/contact"
                className="inline-flex items-center gap-2 px-10 py-5 bg-gradient-glow rounded-xl font-bold text-lg text-white shadow-xl shadow-purple-500/30 hover:shadow-purple-500/50 transition-all duration-300 hover:scale-105 animate-glow"
              >
